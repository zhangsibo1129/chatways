...
with gr.Blocks(css=CSS) as demo:
    ...
    with gr.Row():
        system_prompt = gr.Textbox(placeholder=ARXIV_SYSTEM_PROMPT, show_label=False, interactive=False, scale=9)
    ...
    with gr.Row():
        ...
        with gr.Column(scale=1):
            ...
            paper_cards = gr.Markdown(visible=True, elem_classes=["scrollable-markdown"])
    ...
    inputs.submit(respond, [inputs, chatbot, history_search, max_papers, stream_component, *(parameter_components+availabel_components)], [inputs, chatbot, history_search, paper_cards])
    send_btn.click(respond, [inputs, chatbot, history_search, max_papers, stream_component, *(parameter_components+availabel_components)], [inputs, chatbot, history_search, paper_cards])
